...
This is a new version of the previous evaluation-kit (30th August). 
It included two news:
(1) it removes the non-relevant annotations in predictions and gold
(2) it does not take into account duplicates when evaluating

The rest is the same as the previous evaluation-kit.
